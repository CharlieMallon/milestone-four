...
Users should be able to view products in a collection or as an individual product.  They should be able to search the product base for a particular product or keyword.  Items should be easily added and removed from the shopping basket. Users should be able to checkout with ease, users with a account should be able to see their pervious orders, order status and edit any personal information. Personal information should include; delivery address, name, email address and dietary requirements.
...
<br/>
This page confirms that the order has been received.  It will confirm the delivery date and that a payment of £xx.xx has been taken, as well as wether any special requests/dietary requirements have been made. It will encourage users to register for an account so they can track there order.
<br/>
[Mobile](#) / [Tablet](#) / [Desktop](#)
<br/>
